...
namespace ders2_odev6_1
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            foreach (Urun yeni in Urunler)
            {
                int i = 1;

                Console.WriteLine(i + " Ürün adı: " + yeni.UrunAdi +
                    i + "\n Ürün fiyatı: " + yeni.UrunFiyati +
                    i + "\n İndirim miktarı: " + yeni.İndirimMiktari +
                    i + "\n Ürün kategotisi: " + yeni.UrunKategorisi +
                    i + "\n Ürün markası: " + yeni.Urunmarkasi + "\n");
                i++;
